      ...
      <header className="border-b bg-background/95 backdrop-blur sticky top-0 z-50">
        <div className="container mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            <div className="h-9 w-9 rounded-lg bg-linear-to-br from-primary to-primary/80 flex items-center justify-center">
      ...
      <main className="flex-1">
        <section className="relative py-28 px-6 overflow-hidden">
          ...
          <div className="container mx-auto max-w-4xl text-center">
            ...
            <h1 className="text-5xl sm:text-6xl font-bold tracking-tight mb-6 bg-linear-to-br from-foreground via-foreground to-muted-foreground bg-clip-text">
        ...
        <section className="py-24 px-6 bg-muted/40">
          <div className="container mx-auto max-w-5xl">
            <h2 className="text-2xl font-bold text-center mb-12">Why EduSchool?</h2>
            <div className="grid md:grid-cols-3 gap-6">
              <div className="flex flex-col items-center text-center p-8 rounded-2xl bg-card border shadow-sm hover:shadow-md transition-shadow">
                <div className="h-14 w-14 rounded-2xl bg-linear-to-br from-primary/20 to-primary/5 flex items-center justify-center mb-5">
